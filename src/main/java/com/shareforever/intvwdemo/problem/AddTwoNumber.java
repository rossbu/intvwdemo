...
public class AddTwoNumber {
    ...
    /*
    add the new node as the new head
        or
    you can tail the node
    */
    ...
    public static void main(String args[]) {
        ...
        // back to front and add to head when pushing, so it's 4->6->7->5 in node structure
