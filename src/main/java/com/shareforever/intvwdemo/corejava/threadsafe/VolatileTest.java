 ...
 * volatile  makes sure a var is read from only main memory ( not L1/L2 cache or cpu register
 * volatile just like synchronized, synchronized block will be read in from main memory,
 * volatile and final are enemy, A field cannot be final and volatile at the same time, doing so is a compile time error.t
 */
