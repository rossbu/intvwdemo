...
//        doubleArray(doubleArray);
    ...
    static void fillPrimitiveArray() {
        ...
        java.nio.CharBuffer.wrap(letters).chars().forEachOrdered(System.out::print);System.out.println("\n");


        // fill int[]
        int[] nums = new int[letters.length];
        Arrays.fill(nums, 1);
        IntStream.of(nums).forEachOrdered(System.out::print);System.out.println("\n");
